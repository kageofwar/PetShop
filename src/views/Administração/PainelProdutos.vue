<template>
    ...
    <dialogProduto :open="open" @fechar="open = false" :prdutoref="produtoref"/>

</template>

<script>
    import headerAdmin from '@/components/Auxiliar/Adm/headerAdmin.vue';
    import produtoAdmin from '@/components/Auxiliar/Adm/produtos/produtoAdmin.vue';
    import dialogProduto from '@/components/Auxiliar/Adm/produtos/dialogProduto.vue';
    export default {
        components: {
            headerAdmin,
            produtoAdmin,
        ...
        methods: {
            toggleState() {
            this.isParentStateTrue = !this.isParentStateTrue;
            this.$refs.childComponent.checkParentState();
            }
        },
        computed: {},
        mounted() {
