<template>
  <div class="bg-[--azul-claro]">
    ...
    <div class="flex justify-center items-center">
      <div class="grid grid-cols-2 bg-white items-center mb-1 mt-1 w-[80%]">
        <div>
        ...
        <div>
          ...
          <div class="flex flex-col items-center bg-white rounded-[20px] h-[46vh] p-5">
            ...
            <button
              class="bg-[--azul-escuro] w-[25vh] h-[7vh] flex justify-center items-center rounded-3xl text-white font-bold text-[3.2vh] mt-[4vh]">Comprar</button>
          </div>
          ...
          <div class="flex items-center mt-1 bg-white rounded-[20px] p-1 h-[13vh]">
            <div class="ml-5">
              ...
              <div class="flex space-x-8">
                <input type="text"
                  class="flex justify-center items-center border-[1px] border-black rounded-full placeholder:text-center"
                  placeholder="Digite seu CEP">
                <button
                  class="bg-[--azul-escuro] w-[20vh] h-[5vh] flex justify-center items-center rounded-3xl text-white text-[3.2vh]">Calcular</button>
              </div>
            </div>
          </div>
        </div>
